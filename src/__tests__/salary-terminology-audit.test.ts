...
const AUDITED_FILES = [
  ...
  'src/shared/i18n/translations-milestone3.ts',
  ...
  'src/app/settings/salary/holidays-rest.tsx',
  ...
  'src/features/pay-rules/components/calendar-evidence-preset-preview.tsx',
  'src/features/pay-rules/components/special-pay-interval-card.tsx',
  'src/features/pay-rules/components/special-pay-interval-form.tsx',
  'src/features/pay-rules/components/weekly-rest-settings.tsx',
